# 운임 방향 예측 프롬프트 v1.4 — 해상·항공 공통 (SSOT)
...
5. **분량**: statement **5문장(약 480자) 이내**(※ v1.4 원안의 "280자(3문장)"은 style_rules의 5문장 구조와 충돌 → 사용자 확정대로 5문장 기준), impact_note 160자 이내.

## MODEL_VERSION
narrate/생성 산출물 model_version = **'v1.4'**.

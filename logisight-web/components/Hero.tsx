      ...
      <div className="max-w-page mx-auto flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 lg:gap-10">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex gap-2">
            <button className="bg-cyan text-navy-900 text-xs lg:text-sm font-medium px-4 py-2 rounded-md flex items-center gap-1.5 hover:brightness-110 transition">
              <Brain size={14} />
              이번 주 분석 보기
            </button>
            <button className="bg-transparent text-white text-xs lg:text-sm font-medium px-4 py-2 rounded-md border border-white/25 flex items-center gap-1.5 hover:bg-white/5 transition">
              운임 대시보드
              <ArrowRight size={13} />
            </button>
          </div>

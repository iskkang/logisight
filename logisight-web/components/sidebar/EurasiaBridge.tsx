...
export function EurasiaBridge({ routes }: { routes: RailRoute[] }) {
  return (
    <aside className="bg-navy-900 rounded-xl p-3.5 mb-3.5 relative overflow-hidden">
      ...
      <div className="flex items-center justify-between mb-2.5 relative">
        <h3 className="text-[11px] font-medium text-cyan tracking-[0.06em] uppercase flex items-center gap-1.5">
          <Route size={13} />
          유라시아 코리도어
        </h3>

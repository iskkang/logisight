...
export function IndexBar({
  ...
  return (
    <div className="bg-white border-b border-slate-200 px-5 py-2 flex items-center overflow-x-auto sticky top-0 z-10">
      <div className="max-w-page mx-auto flex items-center w-full">
        {indices.map((idx, i) => (
          <div
            key={idx.name}
            className={`flex flex-col px-3.5 min-w-[90px] flex-shrink-0 ${
        ...
        <div className="flex flex-col px-3.5 min-w-[120px] flex-shrink-0 ml-auto">
          <div className="text-[10px] text-slate-500 font-medium mb-0.5">업데이트</div>

...
export function WeeklyBriefing({ briefing }: { briefing: WeeklyBriefingData }) {
  return (
    <section className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-xl px-5 py-[18px] mb-5 overflow-hidden">
      ...
      <h2 className="text-base font-medium text-navy-900 leading-snug mb-1.5">
        {briefing.title}
      </h2>
      {briefing.subtitle && (
        <div className="text-xs text-navy-400/85 leading-relaxed mb-3.5">
          {briefing.subtitle}
        </div>
      )}
        ...
        {briefing.points.map((point) => {
          ...
          return (
            ...
            >
              ...
              <div className="text-xs text-navy-900 font-medium leading-snug keep-all">
                {point.headline}
              </div>

...
export const NEWS_SOURCES: NewsSource[] = [
  ...
  { name: 'PortNews EN', url: 'https://en.portnews.ru/rss/', kind: 'rss', section: 'rail', language: 'en', monthly: true },
  ...
  { name: 'US CBP Trade News', url: 'https://www.cbp.gov/rss-feeds/trade-news.xml', kind: 'rss', section: 'trade', language: 'en', monthly: true },
  ...
  { name: 'EU Taxation and Customs', url: 'https://taxation-customs.ec.europa.eu/rss.xml', kind: 'rss', section: 'trade', language: 'en', monthly: true },
  { name: 'IMO', url: 'https://www.imo.org/en/MediaCentre/Pages/WhatsNew-RSS.aspx', kind: 'rss', section: 'trade', language: 'en', monthly: true },

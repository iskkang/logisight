...
const REGIONS = ['europe', 'americas', 'russia', 'latam', 'china', 'japan', 'sea', 'mideast', 'africa'];
const PRIORITY = ['russia', 'china', 'sea', 'japan', 'europe', 'americas', 'mideast', 'latam', 'africa'];   // 동률 시 우선순위
...
function assignPool(articles, cfgs, opts = {}) {
  ...
  for (const r of REGIONS) buckets[r] = [];

...
{"news":"운영 동향 요약 또는 \\"\\"","policy":"정책 함의(한국/권역 영향 1~2문장) 또는 \\"\\"","trade":"무역량 동향(기사에 보고된 수치만) 또는 \\"\\"","content":"권역 주간 분석 본문 600~1,000자. 3~5개 단락으로 나누고 단락 사이는 빈 줄(\\n\\n)로 구분. 첫 단락=이번 주 핵심 요약, 중간 단락=이슈별 분석(이슈마다 한 단락), 마지막 단락=한국 화주 시사점·전망. 각 단락 2~4문장"}

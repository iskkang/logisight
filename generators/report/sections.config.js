...
const SECTIONS = [
  ...
  },
  {
    ...
    title: '02. 해운 시황',
    focus:
      '컨테이너·건화물 운임 시황. 아래 6개 소제목 구조 필수. ' +
      ...
      '## 02-6. 종합 전망 — 지수 간 수렴·발산과 시장 방향성 종합. ' +
  ...
  },
  {
    ...
    focus:
      ...
      '아래 4개 소제목 구조 필수, 데이터 없는 지역은 "금월 데이터 미수집" 정직 표기: ' +
      '## 04-1. 중국-유럽 철도 (TCR·일대일로) — 중구반열 운행·물동량, 중국측 국경. ' +
      '## 04-2. 러시아 철도 (TSR·극동) — RZD 동향, 러-중 국경, 대EU 물동량. ' +
      '## 04-3. 유라시아 회랑별 정시 성과 (MTL Link 실측) — ' +
        '주어진 "MTL Link 실측 정시 데이터"의 회랑별 정시율·지연·P90 추이를 분석. ' +
        '표는 시스템이 주입하므로 본문에 표를 그리지 말 것. ' +
        '정시율 급변·꼬리 리스크(P90 확대)를 현상→원인으로 서술하고, 04-1·04-2의 국경 적체·웨건 부족 뉴스와 인과 연결. ' +
        '단 MTL 수치는 "MTL Link TCR-Tracking 실측"으로 명기. ' +
      '## 04-4. 종합 전망 — 유라시아 회랑 시장의 구조적 방향성 종합. ' +
      '각 소제목은 현상에서 원인·배경·전망으로 자연스럽게 이어지는 산문(대괄호 라벨 금지). ' +

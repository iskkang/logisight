...
const SECTIONS = [
  ...
  },
  {
    ...
    focus:
      ...
      '03-2와 03-3은 넓은 표 가독성을 유지한 상하 병합으로 반드시 한 페이지 안에 끝낼 것. 도쿄 노선은 표에서 제외되며, 각 블록 해설은 2문단 이내로 압축. ' +
  ...
  },
  {
    ...
    focus:
      ...
      '★ 큐레이션 기준(엄수): 물동량·운임·규제·항로에 "직접" 영향을 주는 월간 중요도 상위 4건만 선정. ' +
      ...
      '★ 각 이슈 블록의 구조 고정: 소제목 → 도입 문단 → 시각 요소 1개(수치 3개 이상이면 [[STATS:]], 아니면 원기사 URL로 [[OGIMG: URL]] — 반드시 해당 이슈의 실제 기사 URL) → 분석·전망 문단. 시각 요소 없는 텍스트 슬래브 금지. ' +
